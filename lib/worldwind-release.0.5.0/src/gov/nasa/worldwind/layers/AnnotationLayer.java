 ...
 * for rendering and picking. <code>AnnotationLayer</code> delegates to its internal
 * {@link gov.nasa.worldwind.render.AnnotationRenderer} for rendering and picking operations. The
 * <code>AnnotationRenderer</code> is specified by calling {@link #setAnnotationRenderer}.
 *
 * @author Patrick Murris
 * @version $Id: AnnotationLayer.java 4049 2007-12-22 15:59:29Z dcollins $
...
{
    private final java.util.Collection<Annotation> annotations =
    ...
    /**
     * Adds the specified <code>annotation</code> to this layer's internal collection.
     * If this layer's internal collection has been overriden with a call to {@link #setAnnotations},
    ...
    /**
     * Adds the contents of the specified <code>annotations</code> to this layer's internal collection.
     * If this layer's internal collection has been overriden with a call to {@link #setAnnotations},
     * this will throw an exception.
     *
    ...
    /**
     * Removes the specified <code>annotation</code> from this layer's internal collection, if it exists.
     * If this layer's internal collection has been overriden with a call to {@link #setAnnotations},
     * this will throw an exception.
     *
     ...
     * If the caller has specified a custom Iterable via {@link #setAnnotations}, this will returns a reference
     * to that Iterable. If the caller passed <code>setAnnotations</code> a null parameter,
     * or if <code>setAnnotations</code> has not been called, this returns a view of this layer's internal
    ...
    /**
     * Overrides the collection of currently active Annotations with the specified <code>annotationIterable</code>.
     * This layer will maintain a reference to <code>annotationIterable</code> strictly for picking and rendering.
     ...
     * <code>addAnnotation, addAnnotations, or removeAnnotations</code>.
     *
    ...
    {
        this.annotationRenderer.render(dc, getActiveAnnotations());
    }
