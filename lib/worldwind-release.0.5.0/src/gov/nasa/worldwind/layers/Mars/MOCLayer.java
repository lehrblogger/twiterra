 ...
 * @version $Id: MOCLayer.java 5183 2008-04-26 02:10:13Z patrickmurris $
 */
public class MOCLayer extends BasicTiledImageLayer
{
    ...
    private static LevelSet makeLevels()
    {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Mars/MOC");
        params.setValue(AVKey.SERVICE, "http://worldwind25.arc.nasa.gov/mars/mars.aspx");
        params.setValue(AVKey.DATASET_NAME, "moc256");
    ...
    {
        return Logging.getMessage("layers.Mars.MOC.Name");
    }
}