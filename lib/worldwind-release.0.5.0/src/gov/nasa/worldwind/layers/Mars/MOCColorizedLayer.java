 ...
 * @version $Id: MOCColorizedLayer.java 5183 2008-04-26 02:10:13Z patrickmurris $
 */
public class MOCColorizedLayer extends BasicTiledImageLayer
{
    ...
    private static LevelSet makeLevels()
    {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Mars/MOC_Colorized");
        params.setValue(AVKey.SERVICE, "http://worldwind25.arc.nasa.gov/mars/mars.aspx");
        params.setValue(AVKey.DATASET_NAME, "mocC256");
    ...
    {
        return Logging.getMessage("layers.Mars.MOCColorized.Name");
    }
}
