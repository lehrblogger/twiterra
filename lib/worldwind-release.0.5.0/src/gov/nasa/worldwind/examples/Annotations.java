    ...
    private static class AppFrame extends ApplicationTemplate.AppFrame // implements MouseListener
    {
        ...
        private void updateControlPanel()
        {
            if(this.currentAnnotation != null)
            {
                ...
                if (currentAnnotation.getAttributes().getEffect().equals(MultiLineTextRenderer.EFFECT_NONE))
                    cbTextEffect.setSelectedIndex(0);
                else if (currentAnnotation.getAttributes().getEffect().equals(MultiLineTextRenderer.EFFECT_SHADOW))
                    cbTextEffect.setSelectedIndex(1);
                else  if (currentAnnotation.getAttributes().getEffect().equals(MultiLineTextRenderer.EFFECT_OUTLINE))
                ...
                if (currentAnnotation.getAttributes().getImageSource() != null)
                {
                    if (currentAnnotation.getAttributes().getImageSource() instanceof String)
                    {
                        ...
                        if(image.equals(IMAGE_EARTH)) this.cbImage.setSelectedIndex(1);
                        else if(image.equals(IMAGE_NASA)) this.cbImage.setSelectedIndex(2);
                        else if(image.equals(IMAGE_WWJ_SPLASH)) this.cbImage.setSelectedIndex(3);
